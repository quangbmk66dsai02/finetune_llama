...
"""
Câu hỏi phức tạp 1:
Hãy so sánh đặc điểm văn hóa của Đông Sơn, Sa Huỳnh và Óc Eo.

Các câu hỏi đơn giản:
1. Văn hóa Đông Sơn có những đặc điểm gì nổi bật?
2. Văn hóa Sa Huỳnh có những nét riêng gì đáng chú ý?
3. Văn hóa Óc Eo có đặc điểm gì tiêu biểu?
""",
"""
Câu hỏi phức tạp 1:
So sánh chính sách cai trị của nhà Hán và nhà Đường ở Việt Nam.

Các câu hỏi đơn giản:
1. Nhà Hán đã cai trị Việt Nam bằng những chính sách nào?
2. Chính sách cai trị của nhà Đường ở Việt Nam có gì khác biệt?
""",
"""
Câu hỏi phức tạp 1:
So sánh hệ thống hành chính dưới thời Lý, Trần và Nguyễn.

Các câu hỏi đơn giản:
1. Hệ thống hành chính thời Lý được tổ chức ra sao?
2. Triều Trần đã cải biến gì trong hệ thống hành chính?
3. Hệ thống hành chính dưới triều Nguyễn có đặc điểm gì?
""",
"""
Câu hỏi phức tạp 1:
Phân tích chiến lược kháng chiến của Việt Nam trong thời kỳ chống Pháp và Nhật.

Các câu hỏi đơn giản:
1. Chiến lược kháng chiến chống Pháp giai đoạn 1945–1954 như thế nào?
2. Kháng chiến chống Nhật Bản trong Thế chiến II có những đặc điểm gì?
""",
"""
Câu hỏi phức tạp 1:
So sánh vai trò của Mặt trận Dân tộc Giải phóng miền Nam và quân Giải phóng miền Nam trong kháng chiến chống Mỹ.

Các câu hỏi đơn giản:
1. Mặt trận Dân tộc Giải phóng miền Nam có vai trò gì trong cuộc kháng chiến?
2. Quân Giải phóng miền Nam đã đóng góp thế nào trong các chiến dịch lớn?
""",
"""
Câu hỏi phức tạp 1:
